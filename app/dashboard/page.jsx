    ...
    <section className={`${isLoggedIn? "lg:px-28":"px-0"} block justify-center items-center`}>
      {isLoggedIn ? (
        <div className="container mx-auto py-8">
          <div className="md:flex lg:w-full  flex-wrap border  justify-center sm:justify-between items-center">
            <h2>My Orders</h2>
            <div className="flex flex-col items-center gap-2 lg:gap-8">
              <button className="w-[120] lg:w-[219] bg-primary rounded-md btnText text-white h-[40]">Add Order</button>
