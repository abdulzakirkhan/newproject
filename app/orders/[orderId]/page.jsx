...
const OrderDetail = ({ params }) => {
  ...
  <div className="container mx-auto px-6">
    <div className="grid wrap md:grid-cols-12 gap-5">
      {/* Card Section */}
      <motion.div
        className="w-[320] md:w-full md:col-span-8 shadow-custom rounded-2xl hover:shadow-lg hover:scale-105 transition-all duration-300 ease-in-out"
      ...
      >
        ...
        {/* Order Details */}
        <motion.div
          className="flex wrap w-[330] md:w-full lg:flex-nowrap px-3 justify-between items-start py-3"
          initial={{ opacity: 0 }}
          whileInView={{ opacity: 1 }}
        ...
        {/* Payment Details */}
        <motion.div
          className="flex w-[320] md:w-full wrap flex-col gap-4 mt-5 px-3 pb-6"
          initial={{ opacity: 0 }}
          whileInView={{ opacity: 1 }}
